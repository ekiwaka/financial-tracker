...
def generateBudgetsReport(userID, year=None):
    ...
    budgetsReport = view_dashboard.getBudgets(userID, year)
...
def generateMonthlyReport(userID, year=None):
    ...
    spending_month_chart = view_dashboard.getMonthlySpending(userID, year)
...
def generateSpendingTrendsReport(userID, year=None):
    ...
    spending_trends_chart = view_dashboard.getSpendingTrends(userID, year)
    ...
    categories_active = view_categories.getSpendCategories(userID)
    ...
    categories_inactive = view_categories.getSpendCategories_Inactive(userID)
